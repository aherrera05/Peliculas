...
// All together
  async componentDidMount(genres, ranking) {
    try {
  ...
  changeRanking(ranking) {
    this.componentDidMount(ranking);
}
  // Render
 render() {
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                  <ul className="navbar-nav ml-auto">
                    ...
                    <li>
                      ...
                      <li>
                        <Dropdown>
                          <Dropdown.Toggle variant="danger" id="dropdown-basic"> Ordenar por Nota </Dropdown.Toggle>
                          <Dropdown.Menu>  {[1,2,3,4,5,6,7,8,9].map(ranking => (  
                            <Dropdown.Item  eventKey={ranking} key={ranking} onSelect={ranking => this.changeRanking(ranking)} > {ranking}
                            </Dropdown.Item> ))}
                            </Dropdown.Menu>
                          </Dropdown>
                      </li>
